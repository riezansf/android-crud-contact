...
-keepclassmembers class uk.co.ribot.androidboilerplate.contactData.model.** {
...
-keepclassmembers class uk.co.ribot.androidboilerplate.contactData.remote.RibotsService$** {
    !static !private <fields>;
}
