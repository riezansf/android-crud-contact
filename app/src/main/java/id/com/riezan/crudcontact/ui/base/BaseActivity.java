package id.com.riezan.crudcontact.ui.base;
...
import id.com.riezan.crudcontact.injection.component.ActivityComponent;
import id.com.riezan.crudcontact.injection.component.ConfigPersistentComponent;
import id.com.riezan.crudcontact.injection.component.DaggerConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (configPersistentComponent == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(CrudContactApplication.get(this).getComponent())
                    .build();
